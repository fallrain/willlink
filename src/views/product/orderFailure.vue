<template>
  <div class="orderBox">
    <div class="navBox">
      <van-nav-bar :title="title" right-text="关闭"   @click-right="onClickRight" class="main-header"/>
    </div>
    <div class="content">
      <div class="info">
      ...
      <div class="info">
        <div class="line">
          ...
          <div class="type text-right right">2019-06-19 14:43</div>
        </div>
        <div class="line">
          <div class="name text-left left">交易流水</div>
          <div class="type text-right right">akjfhsk82957BFDJKH78345HJDG</div>
        </div>
        <div class="line">
      ...
      <div class="steps">
        ...
        <van-steps direction="vertical" :active="2" active-color="#59C1B6">
          <van-step>
            <h3>提交订单</h3>
          </van-step>
          <van-step>
